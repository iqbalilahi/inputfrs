    ...
    <section class="content">
        <div class="box box-warning box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">INPUT DATA TBL_MHS</h3>
            </div>
...
<table class='table table-bordered>'        
	    ...
	    <!-- <tr><td width='200'>Id Jenjangstudi <?php echo form_error('id_jenjangstudi') ?></td><td><input type="text" class="form-control" name="id_jenjangstudi" id="id_jenjangstudi" placeholder="Id Jenjangstudi" value="<?php echo $id_jenjangstudi; ?>" /></td></tr> -->
	   ...
	   <!--  <tr><td width='200'>Id Prodi <?php echo form_error('id_prodi') ?></td><td><input type="text" class="form-control" name="id_prodi" id="id_prodi" placeholder="Id Prodi" value="<?php echo $id_prodi; ?>" /></td></tr> -->
	    ...
	    <a href="<?php echo site_url('mhs') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a></td></tr>
	</table></form>        </div>
</div>
</div>